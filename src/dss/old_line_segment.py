...
def annotate_image_with_lines(im, lines):
    """Return the source image, annotated with line bounds.
...
def to_chunks(image, n_chunks):
    ...
    :param n_chunks: The amount of chunks.
    :return: The lis of chunks.
    """
    w = image.shape[1]
...
def piece_wise_segment(im, n_splits=20, line_start_splits=10, start_lookahead=50, chunk_lookahead=40,
    ...
    :param im: The source image.
    :param n_splits: The amount of splits to use.
    :param line_start_splits: How many splits to use to determine the start of the lines.
    :param start_lookahead: The peakdetect lookahead to use when determining the start of the lines.
    :param chunk_lookahead: The peakdetect lookahead to use when determining line continuations.
    :param expected_line_height: The expected height of lines.
...
def image_between_lines(im, line1, line2, ccs, offset):
    """Return the image between two lines, from a source image.

    :param im: The source image.
    :param line1: The first line.
    :param line2: The second line.
    :param ccs: The connected component list to extract components from.
    :param offset: The cropping offset.
    :return: The image between two lines, from a source image.
    """
    (ox, oy, ow, oh) = offset
